...
export default class InfiniteScroll extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    // if (this.props.gridSize !== this.props.videoPageSize) {
    //   this.actionTriggered = true;
    //   this.setState({ showLoader: true });
    //   this.props.next && this.props.next();
    //   this.props.setVideoPageSize(this.props.gridSize);
    // }
  }
  ...
  render() {
    ...
    return (
      <div style={outerDivStyle} className="infinite-scroll-component__outerdiv">
        <div className={`infinite-scroll-component ${this.props.className || ""}`} ref={(infScroll) => (this._infScroll = infScroll)} style={style}>
